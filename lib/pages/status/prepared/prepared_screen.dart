...
import 'package:rent_car/pages/status/prepared/detail_prepared_screen.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('paymentStatus', isEqualTo: 'Disiapkan')
            .snapshots(),
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                DetailPreparedScreen(dataPayment: payment),
                          ));
                        },
                      ),
                    ),
